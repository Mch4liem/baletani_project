...
<html lang="en">
  <head>
    ...
    <title>BaleTani Admin</title>
  </head>
  <body>
    <h1 class="text-center mb-4">Edit Data Petani</h1>
    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-8">
              <div class="card">
                <div class="card-body">
                  <form action="/updatepetani/{{ $data->id }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                      ...
                      <input type="number" name="upah" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="{{ $data->upah }}">
